...
Η κατάτμηση συστήματος (root) πρέπει να είναι τουλάχιστον %1.</translation>
    ...
    <message>
        ...
        <translation type="vanished">Η κατάτμηση που επιλέξατε για το Σύστημα (root), δεν είναι του Linux. Είστε σίγουροι πως θέλετε να ξανακάνετε φορμά σε αυτή την κατάτμηση;</translation>
    </message>
    <message>
...
Are you sure you want to reformat this partition?</source>
        <translation type="vanished">Η κατάτμηση που επιλέξατε για %1, δεν είναι του Linux.
Είστε σίγουροι πως θέλετε να ξανακάνετε φορμά σε αυτή την κατάτμηση;</translation>
    ...
    <message>
        ...
        <translation type="vanished">Είναι ΟΚ να ξαναχρησιμοποιηθεί το %1 (χωρίς reformat), σαν Κατάτμηση Χρήστη  /home</translation>
    </message>
    <message>
        <source>OK to format and destroy all data on %1 for the /home partition?</source>
        <translation type="vanished">Είναι ΟΚ να γίνει format και να καταστραφούν όλα τα δεδομένα στο %1 στη Κατάτμηση Χρήστη (/home)</translation>
    </message>
    <message>
        <source>The partition you selected for /boot, is larger than expected.
Are you sure you want to reformat this partition?</source>
        <translation type="vanished">Η κατάτμηση που επιλέξατε για / boot, είναι μεγαλύτερο από το αναμενόμενο.
Είστε βέβαιοι ότι θέλετε να αναδιαμορφώσετε αυτό το διαμέρισμα;</translation>
    ...
    <message>
        ...
        <translation type="vanished">Παρακαλώ περιμένετε μέχρι να εγκατασταθεί το GRUB, αυτό μπορεί να πάρει μερικά λεπτά.</translation>
    </message>
    <message>
...
Do you want to reboot now?</source>
        <translation type="vanished">Η εγκατάσταση και η ρύθμιση ολοκληρώθηκαν. 
...
Θέλετε πραγματικά να σταματήσετε τώρα;</translation>
    ...
    <message>
        ...
        <translation type="vanished">&lt;p&gt;&lt;b&gt;Η εγκατάσταση προχωρά&lt;/b&gt;&lt;br/&gt;Το %1 εγκαθίσταται. Μία νέα εγκατάσταση, θα πάρει πιθανώς περί τα 3-20 λεπτά, ανάλογα με την ταχύτητα του συστήματός σας και το μέγεθος των κατατμήσεων τις οποίες επαναχρησιμοποιείτε.&lt;/p&gt;&lt;p&gt;Αν κάνετε κλικ στο κουμπί Ματαίωση, η εγκατάσταση θα σταματήσει το συντομότερο δυνατόν.&lt;/p&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">3. Γίνεται εγκατάσταση</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Έτοιμοι για την εγκατάσταση του Συστήματος Αρχείων του antiX Linux</translation>
    </message>
    <message>
