...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Συλλέγουμε πληροφορίες, παρακαλώ περιμένετε.</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="53"/>
        <source>Shutdown</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="110"/>
        <source>Support %1
...
Το %1 στηρίζεται από ανθρώπους σαν κι&apos; εσάς. Κάποιο βοηθούν κάποιους άλλους στο forum υποστήριξης- %2, ή μεταφράζουν αρχεία βοήθειας σε διάφορες γλώσσες, ή κάνουν υποδείξεις, γράφουν τεκμηρίωση, ή βοηθούν δοκιμάζοντας νέο λογισμικό.&lt;/p&gt;</translation>
    ...
    <message>
        <location filename="../minstall.cpp" line="187"/>
        <source>Cannot access source medium.
Activating pretend installation.</source>
        <translation>Δεν είναι δυνατή η πρόσβαση στο μέσο προέλευσης.
Ενεργοποίηση της προσποιημένης εγκατάστασης.</translation>
    </message>
    <message>
...
Απολαύστε τη χρήση του %1.</translation>
    ...
    <message>
        ...
        <translation>στοχευμένο σκληρό δίσκο</translation>
    </message>
    <message>
...
Οι δίσκοι με το διαμέρισμα που έχετε επιλέξει για την εγκατάσταση αποτυγχάνουν.
    ...
    <message>
        <location filename="../minstall.cpp" line="586"/>
    ...
    <message>
        <location filename="../minstall.cpp" line="598"/>
...
έναν μεγαλύτερο κωδικό πρόσβασης πριν προχωρήσετε.</translation>
    ...
    <message>
        ...
        <translation>Δεν ήταν δυνατή η διαμόρφωση των απαιτούμενων διαμερισμάτων.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Μορφοποίηση του χώρου συστήματος EFI</translation>
    </message>
    <message>
...
Η κατάτμηση συστήματος (root) πρέπει να είναι τουλάχιστον %1.</translation>
    ...
    <message>
        ...
        <translation>Το πρόγραμμα εγκατάστασης %1 θα διαμορφώσει και θα καταστρέψει τα δεδομένα στα ακόλουθα διαμερίσματα:</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="1215"/>
        <source>The %1 installer will now perform the following actions:</source>
        <translation>Το πρόγραμμα εγκατάστασης %1 θα εκτελέσει τώρα τις ακόλουθες ενέργειες:</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../minstall.cpp" line="1494"/>
        <source>Deleting old system</source>
        <translation>Διαγραφή παλιού συστήματος</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="1498"/>
...
Επιστροφή στο Βήμα 1.</translation>
    ...
    <message>
        ...
        <translation>Αντιγραφή προόδου άγνωστη. Δεν υπάρχουν στατιστικά στοιχεία συστήματος αρχείων.</translation>
    </message>
    <message>
...
Επιστροφή στο Βήμα 1. </translation>
    ...
    <message>
        ...
        <translation>Επαναφορά της μεταβλητής ενημέρωσης εκκίνησης NVRAM. Το σύστημα μπορεί να μην εκκινήσει, αλλά μπορεί να επισκευαστεί με το μενού εκκίνησης GRUB Rescue.</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="1936"/>
        <source>Please enter a user name.</source>
        <translation>Παρακαλώ εισάγετε όνομα χρήστη.</translation>
    </message>
    <message>
...
Επιλέξτε ένα διαφορετικό όνομα.</translation>
    ...
    <message>
        ...
        <translation>Εισαγάγετε τον κωδικό πρόσβασης χρήστη.</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="1966"/>
        <source>Please enter the root password.</source>
        <translation>Εισαγάγετε τον κωδικό πρόσβασης διαχειριστή.</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="1972"/>
        <source>The user password entries do not match.
Please try again.</source>
        <translation>Οι καταχωρίσεις κωδικού χρήστη δεν συμφωνούν.
ΠΑΡΑΚΑΛΩ προσπαθησε ξανα.</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="1979"/>
        <source>The root password entries do not match.
Please try again.</source>
        <translation>Οι καταχωρήσεις κωδικού πρόσβασης διαχειριστή δεν ταιριάζουν.
ΠΑΡΑΚΑΛΩ προσπαθησε ξανα.</translation>
    </message>
    <message>
...
πριν προχωρήσετε.</translation>
    ...
    <message>
        ...
        <translation>Εάν το διαμέρισμα που περιέχει το /home είναι κρυπτογραφημένο, βεβαιωθείτε ότι έχουν επιλεγεί τα σωστά πλαίσια &quot;Κρυπτογράφηση&quot; και ότι ο κωδικός πρόσβασης που έχει εισαχθεί είναι σωστός.</translation>
    </message>
    <message>
        ...
        <translation>Το πρόγραμμα εγκατάστασης δεν μπορεί να κρυπτογραφήσει έναν υπάρχοντα /home κατάλογο ή ένα διαμέρισμα.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Η εγκατάσταση απαιτεί περίπου %1 χώρου. %2 ή περισσότερο προτιμάται. Μπορείτε να χρησιμοποιήσετε ολόκληρο το δίσκο ή να εγκαταστήσετε σε υπάρχοντα διαμερίσματα.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Τα συστήματα αρχείων ext2, ext3, ext4, jfs, xfs, btrfs και reiserfs Linux υποστηρίζονται και συνιστάται το ext4.</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="2438"/>
        <source>Autoinstall will place home on the root partition.</source>
        <translation>Η αυτόματη εγκατάσταση θα τοποθετηθεί /home στο διαμέρισμα root.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Απαιτείται ξεχωριστό μη κρυπτογραφημένο διαμέρισμα εκκίνησης. Για πρόσθετες ρυθμίσεις, συμπεριλαμβανομένης της επιλογής κρυπτογράφησης, χρησιμοποιήστε το κουμπί &lt;b&gt;Προηγμένες ρυθμίσεις κρυπτογράφησης&lt;/b&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Για να κάνετε αναβάθμιση από μια υπάρχουσα εγκατάσταση Linux, επιλέξτε το ίδιο αρχικό διαμέρισμα όπως και πριν και ελέγξτε την προτίμηση για τη διατήρηση δεδομένων στο /home.</translation>
    </message>
    <message>
        ...
        <translation>Εάν διατηρείτε μια υπάρχουσα καταλόγου /home που βρίσκεται στο τμήμα /root, το πρόγραμμα εγκατάστασης δεν θα μετασχηματίσει ξανά το διαμέρισμα /root. Ως αποτέλεσμα, η εγκατάσταση θα διαρκέσει πολύ περισσότερο από το συνηθισμένο.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Για το %1, μπορείτε να επιλέξετε να διαμορφώσετε τα διαμερίσματα ως ext2, ext3, ext4, f2fs, jfs, xfs, btrfs ή reiser.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Bad Blocks</translation>
    </message>
    <message>
        ...
        <translation>Αν επιλέξετε ext2, ext3 ή ext4 ως τύπο μορφής, έχετε την επιλογή να ελέγξετε και να διορθώσετε τα badblocks στη μονάδα δίσκου. Ο έλεγχος badblock είναι πολύ χρονοβόρος, οπότε μπορεί να θέλετε να παραλείψετε αυτό το βήμα, εκτός αν υποψιάζεστε ότι η μονάδα δίσκου σας έχει badblock.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Μπορείτε να χρησιμοποιήσετε το κουμπί &lt;b&gt;Benchmark&lt;/b&gt; (το οποίο τρέχει το &lt;i&gt;benchmark κρυπτογράφησης&lt;/i&gt; στο δικό του παράθυρο τερματικού) για να συγκρίνετε την απόδοση των κοινών συνδυασμών των hashes, των κρυπτών και των τρόπων αλυσίδας.</translation>
    </message>
    <message>
        ...
        <translation>Σημειώστε ότι το &lt;i&gt;κριτήριο αναφοράς cryptsetup&lt;/i&gt; δεν καλύπτει όλους τους συνδυασμούς ή τις επιλογές που είναι δυνατόν και γενικά καλύπτει τις πιο συχνά χρησιμοποιούμενες επιλογές.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ήταν ένας από τους πέντε φιναλίστ του AES. Θεωρείται ότι έχει μεγαλύτερο περιθώριο ασφαλείας από ό, τι ο Rijndael και όλοι οι άλλοι φιναλίστ AES. Λειτουργεί καλύτερα σε ορισμένες CPU 64 bit.</translation>
    </message>
    <message>
        ...
        <translation>(επίσης γνωστή ως&lt;i&gt; Rijndael&lt;/i&gt;) είναι ένας πολύ κοινός κωδικός και πολλές σύγχρονες CPU περιλαμβάνουν οδηγίες ειδικά για το AES, λόγω της πανταχού παρουσίας. Αν και ο Rijndael επιλέχθηκε για το Serpent για τις επιδόσεις του, καμία επίθεση δεν αναμένεται επί του παρόντος να είναι πρακτική.</translation>
    </message>
    <message>
        ...
        <translation>είναι ο διάδοχος του Blowfish. Έγινε ένας από τους πέντε φιναλίστ AES, αν και δεν επιλέχτηκε για το πρότυπο.</translation>
    </message>
    <message>
        ...
        <translation>(CAST-256) ήταν υποψήφιος στο διαγωνισμό AES, ωστόσο δεν έγινε φιναλίστ.</translation>
    </message>
    <message>
        ...
        <translation>είναι ένα κρυπτογραφημένο τετραγωνικό ψηφίο 64-bit που δημιουργήθηκε από τον Bruce Schneier. Δεν συνιστάται για ευαίσθητες εφαρμογές, καθώς υποστηρίζονται μόνο οι τρόποι λειτουργίας CBC και ΕΚΤ. Το Blowfish υποστηρίζει μεγέθη κλειδιών μεταξύ 32 και 448 bits που είναι πολλαπλάσια των 8.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το βιβλίο κωδικών Tweaked που βασίζεται στο XEX με κλοπή κλεψίματος) είναι μια σύγχρονη αλυσίδα, η οποία αντικαθιστά την CBC και την EBC. Είναι η προεπιλεγμένη (και συνιστώμενη) αλυσίδα λειτουργίας. Η χρήση του ESSIV έναντι του Plain64 θα επιφέρει ποινή απόδοσης, με αμελητέα κέρδη ασφαλείας.</translation>
    </message>
    <message>
        ...
        <translation>(Cipher Blocking Chaining) είναι απλούστερη από την XTS, αλλά είναι ευάλωτη σε μια επίθεση με παρεμβολές στο μαντείο (που μετριάζεται κάπως από το ESSIV) και δεν συνιστάται για ευαίσθητες εφαρμογές.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Για τα XTS και CBC, αυτό επιλέγει τον τρόπο δημιουργίας του φορέα αρχικοποίησης. Το &lt;b&gt;ESSIV &lt;/b&gt;απαιτεί μια συνάρτηση κατακερματισμού και, για αυτό το λόγο, θα είναι διαθέσιμο ένα δεύτερο αναπτυσσόμενο πλαίσιο εάν αυτή είναι επιλεγμένη. Οι διαθέσιμες αντιστροφές εξαρτώνται από τον επιλεγμένο κωδικό.</translation>
    </message>
    <message>
        ...
        <translation>Ο τρόπος λειτουργίας της ΕΚΤ δεν χρησιμοποιεί σύστημα IV, επομένως όλα τα πεδία θα απενεργοποιηθούν εάν η ΕΚΤ έχει επιλεγεί για τη λειτουργία αλυσίδας.
&#xa0;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ορίζει το μέγεθος του κλειδιού σε bits. Τα διαθέσιμα μεγέθη κλειδιών περιορίζονται από τον τρόπο κρυπτογράφησης και αλυσίδας.</translation>
    </message>
    <message>
        ...
        <translation>Ο τρόπος αλυσίδας κρυπτογράφησης XTS χωρίζει το κλειδί στο μισό (για παράδειγμα, το AES-256 σε λειτουργία XTS απαιτεί μέγεθος κλειδιού 512 bit).</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το hash που χρησιμοποιήθηκε για το PBKDF2 και για τον διαχωριστή AF.</translation>
    </message>
    <message>
        ...
        <translation>Τα SHA-1 και RIPEMD-160 δεν συνιστώνται πλέον για ευαίσθητες εφαρμογές, καθώς διαπιστώθηκε ότι έχουν σπάσει.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Οι ρυθμίσεις που δημιουργούν γεννήτρια τυχαίων αριθμών πυρήνα θα χρησιμοποιηθούν για τη δημιουργία του κύριου πλήκτρου έντασης του πλήκτρου (το οποίο είναι ένα μακροπρόθεσμο κλειδί).</translation>
    </message>
    <message>
        ...
        <translation>Δύο επιλογές είναι διαθέσιμες: /dev/&lt;b&gt;random &lt;/b&gt;που μπλοκάρει μέχρις ότου επιτευχθεί επαρκής εντροπία (μπορεί να πάρει πολύ χρόνο σε καταστάσεις χαμηλής εντροπίας) και /dev/&lt;b&gt;urandom &lt;/b&gt;που δεν θα μπλοκάρει ακόμη και αν υπάρχει ανεπαρκής εντροπία (πιθανώς ασθενέστερα κλειδιά).</translation>
    </message>
    <message>
        ...
        <translation>KDF round time&lt;/b&gt;&lt;br/&gt;Το χρονικό διάστημα (σε χιλιοστά του δευτερολέπτου) για να περάσετε με επεξεργασία PBKDF2 passphrase.</translation>
    </message>
    <message>
        ...
        <translation>Μια τιμή 0 επιλέγει την προεπιλεγμένη συνάρτηση (εκτελέστε &lt;i&gt;cryptsetup -help &lt;/i&gt;για λεπτομέρειες).</translation>
    </message>
    <message>
        ...
        <translation>Αν έχετε αργό μηχάνημα, ίσως θελήσετε να αυξήσετε αυτήν την τιμή για επιπλέον ασφάλεια, σε αντάλλαγμα για το χρόνο που απαιτείται για να ξεκλειδώσετε έναν τόμο μετά την εισαγωγή μιας φράσης πρόσβασης.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Προεπιλογές τοπικής ρύθμισης</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ρύθμιση Ωρολογίου</translation>
    </message>
    <message>
...
Το %1 στηρίζεται από ανθρώπους σαν κι&apos; εσάς. Κάποιο βοηθούν κάποιους άλλους στο forum υποστήριξης- %2, ή μεταφράζουν αρχεία βοήθειας σε διάφορες γλώσσες, ή κάνουν υποδείξεις, γράφουν τεκμηρίωση, ή βοηθούν δοκιμάζοντας νέο λογισμικό.&lt;/b&gt;</translation>
    ...
    <message>
        ...
        <translation>Επιλέξτε το διαμέρισμα στόχευσης root</translation>
    </message>
    <message>
...
Θέλετε πραγματικά να σταματήσετε τώρα;</translation>
    ...
    <message>
        ...
        <translation type="vanished">Ή επιλογή αυτή κρυπτογραφεί επίσης το διαμέρισμα swap, αν επιλεγεί, πράγμα που θα καταστήσει δυνατή την κοινή χρήση του διαμερίσματος swap με άλλα εγκατεστημένα λειτουργικά συστήματα.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="../meinstall.ui" line="2741"/>
        <source>Back</source>
        <translation>Πίσω </translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2748"/>
        <source>Alt+K</source>
        <translation>Alt+K</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2761"/>
        <source>Installation in progress</source>
        <translation>Εγκατάσταση σε εξέλιξη</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2776"/>
        <source>Abort</source>
        <translation>Ματαίωση</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="1677"/>
        <location filename="../meinstall.ui" line="2779"/>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <source>Gathering Information, please stand by.</source>
        <translation type="unfinished">Συλλέγουμε πληροφορίες, παρακαλώ περιμένετε.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αναδιάταξη χωρισμάτων δίσκου (προαιρετικά)</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="378"/>
        <source>Modify partitions:</source>
        <translation>Τροποποίηση Κατατμήσεων:</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="394"/>
    ...
    <message>
        ...
        <location filename="../meinstall.ui" line="1110"/>
    ...
    <message>
        ...
        <location filename="../meinstall.ui" line="980"/>
        <source>f2fs</source>
    ...
    <message>
        <location filename="../meinstall.ui" line="816"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="869"/>
        <source>Label</source>
    ...
    <message>
        <location filename="../meinstall.ui" line="1252"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="1412"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="1449"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="1499"/>
        <source>BENBI</source>
    ...
    <message>
        <location filename="../meinstall.ui" line="1693"/>
        <source>System boot disk:</source>
        <translation>Δίσκος εκκίνησης συστήματος:</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="1715"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="1724"/>
        <source>Alt+B</source>
    ...
    <message>
        <location filename="../meinstall.ui" line="1813"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="2015"/>
        <source>Configure Clock</source>
        <translation>Ρύθμιση Ωρολογίου</translation>
    </message>
    <message>
        <source>System clock uses LOCAL</source>
        <translation type="vanished">Το ρολόι του συστήματος χρησιμοποιεί ώρα LOCAL</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2056"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="2358"/>
        <source>Confirm root password:</source>
        <translation>Επιβεβαιώστε τον Κωδικό Συστήματος:</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2371"/>
        <source>Root password:</source>
        <translation>Κωδικός του χρήστη root:</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2387"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="2478"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="2510"/>
        <source>Autologin</source>
        <translation>Autologin</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2523"/>
        <source>Show passwords</source>
        <translation>Εμφάνιση κωδικών</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2536"/>
    ...
    <message>
        <location filename="../meinstall.ui" line="2578"/>
        <source>Re-use it for this installation</source>
        <translation>Επαναχρησιμοποιήστε το για αυτήν την εγκατάσταση</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2585"/>
        <source>Rename it and create a new directory</source>
        <translation>Μετονομάστε το και δημιουργήστε ένα νέο κατάλογο</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2592"/>
        <source>Delete it and create a new directory</source>
        <translation>Διαγράψτε το και δημιουργήστε έναν νέο κατάλογο</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2631"/>
        <source>Tips</source>
        <translation>Συμβουλές</translation>
    </message>
    <message>
        <location filename="../meinstall.ui" line="2675"/>
