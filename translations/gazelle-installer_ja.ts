...
Step 1 へ処理を戻します。</translation>
    ...
    <message>
        ...
        <translation type="vanished">ごめんなさい。 GRUB インストールに失敗しました。これはディスクフォーマットの変化した事に起因し得ます。GRUBをオフにして LiveDVD・LiveUSB を再起動し、GRUB 再インストール機能を使用して復旧インストールを行う事でインストールを完了できます。</translation>
    </message>
    <message>
