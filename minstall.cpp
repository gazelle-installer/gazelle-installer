...
void MInstall::pageDisplayed(int next) noexcept
{
    ...
    case Step::Partitions:
        textHelp->setText("<p><b>" + tr("Choose Partitions") + "</b><br/>"
            ...
            "<li>" + tr("Format - Format without mounting.") + "</li>"
            "<li>" + tr("BIOS-GRUB - BIOS Boot GPT partition for GRUB.") + "</li>"
            "<li>" + tr("/boot/efi - EFI System Partition.") + "</li>"
            "<li>" + tr("/boot - Boot manager.") + "</li>"
            "<li>" + tr("/ - System root.") + "</li>"
            "<li>" + tr("/home - User data.") + "</li>"
            "<li>" + tr("/usr - Static data.") + "</li>"
            "<li>" + tr("/var - Variable data.") + "</li>"
            "<li>" + tr("swap - Swap space.") + "</li></ul>"
